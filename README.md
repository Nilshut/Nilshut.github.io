...
- [x] Installation: How can I install the visualization project (step-by-step manual)?
- [x] Manual: A brief manual about how to use the software. For this it makes sense to use screencasts or screenshots.
